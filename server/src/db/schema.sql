...
-- Keep existing databases aligned with the required contact fields.
ALTER TABLE delivery_points
    ALTER COLUMN customer_name SET NOT NULL,
    ALTER COLUMN customer_phone SET NOT NULL;

ALTER TABLE delivery_points
    DROP CONSTRAINT IF EXISTS delivery_points_customer_phone_check,
    ADD CONSTRAINT delivery_points_customer_phone_check
