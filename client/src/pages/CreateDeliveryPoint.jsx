              ...
              <form onSubmit={handleCreate}>
                ...
                <div className="row-2">
                  ...
                  <div className="field">
                    ...
                    <input type="tel" placeholder="e.g. +919876543210" value={form.customerPhone} onChange={(e) => set("customerPhone", e.target.value)} pattern="\\+[1-9][0-9]{7,14}" required />
                    <div className="hint">Use international format, starting with + and your country code.</div>
                  </div>
                </div>
